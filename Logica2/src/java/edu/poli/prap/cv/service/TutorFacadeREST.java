...
import edu.poli.prap.cv.data.Tutor;
 ...
 */
@Stateless
@Path("edu.poli.prap.cv.data.tutor")
public class TutorFacadeREST extends AbstractFacade<Tutor> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Long id, Tutor entity) {
        super.edit(entity);
    }
    ...
    public Tutor find(@PathParam("id") Long id) {
