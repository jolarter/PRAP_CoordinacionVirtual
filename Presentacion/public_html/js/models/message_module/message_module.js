...
// Model for MessageModule entity
    models.MessageModule = Backbone.Model.extend({
    ...
    // Collection class for MessageModule entities
    models.MessageModuleCollection = Backbone.Collection.extend({
...
$(function () {
    ...
    var AppRouter = Backbone.Router.extend({
        ...
        list: function () {
            this.collection = new models.MessageModuleCollection();
            var self = this;
            this.collection.fetch({
                success: function () {
                    self.listView = new views.ListView({
                        model: self.collection,
                        // tpl-messagemodule-list-itemis template identifier for item
                        templateName: '#tpl-messagemodule-list-item'
                    });
        ...
        details: function (id) {
            if (this.collection) {
                this.messagemodule = this.collection.get(id);
                if (this.view) {
                    this.view.close();
                }
                var self = this;
                this.view = new views.ModelView({
                    model: this.messagemodule,
                    // tpl-messagemodule-details is template identifier for chosen model element
                    templateName: '#tpl-messagemodule-details',
        ...
        create: function () {
            ...
            var self = this;
            var dataModel = new models.MessageModule();
            // see isNew() method implementation in the model
            dataModel.notSynced = true;
            this.view = new views.ModelView({
                model: dataModel,
                collection: this.collection,
                // tpl-messagemodule-details is a template identifier for chosen model element
                templateName: '#tpl-messagemodule-details',
        ...
        getData: function () {
            return {
                 ...
                 * f.e.
                 * idMessageModule:$('#idMessageModule').val(),
                 * ....
                 */
            };
        }
